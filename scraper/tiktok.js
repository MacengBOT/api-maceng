...
const titoko = `https://api-maceng.herokuapp.com//downloader/tiktoknowm?link=${url}`
const tikitoko = `https://api-maceng.herokuapp.com//converter/tomp3?url=https://api-maceng.herokuapp.com//downloader/tiktoknowm?link=${url}`
const obj = {
	videoInfo: {
		id: ingfo.id,
		desc: ingfo.text,
